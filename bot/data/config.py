...
NAME_AUTHOR_VPN = 'Александр' # Имя кто создал VPN
NAME_VPN_CONFIG = 'VPCoden' # Название бота (только буквы и цифры)
...
OPLATA = True # Вкл/выкл систему оплаты (пример: продажа VPN через магазины, только через промокоды)
...
WHY_VPN_PAY = True # Вкл/выкл кнопку "Почему VPN платный?"
